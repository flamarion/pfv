...
| `JWT_REFRESH_TOKEN_EXPIRE_DAYS` | no | `7` | `.env` | unset | inherit default | no | Refresh-token lifetime. | Default 7. |
| `SESSION_LIFETIME_DAYS` | no | `30` | `.env` | unset | inherit default | no | Absolute session ceiling. | Default 30. |
